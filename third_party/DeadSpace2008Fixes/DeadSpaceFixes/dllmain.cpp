...
DWORD WINAPI MainThread(LPVOID)
{
	...
	// DS1K keeps the Korean UTF-8 decoder isolated from the upstream fix pack.
	// Loading it here avoids a second xinput proxy while preserving the original
	// DeadSpace2008Fixes feature set and its SDL controller implementation.
