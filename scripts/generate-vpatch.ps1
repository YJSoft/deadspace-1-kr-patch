...
if ([string]::IsNullOrWhiteSpace($OutputPatch)) {
    $OutputPatch = Join-Path $repoRoot "packaging\patches\deadspace1-kr-v0.3.1.pat"
}
...
$workPatch = Join-Path $workRoot "deadspace1-kr-v0.3.1.pat"
